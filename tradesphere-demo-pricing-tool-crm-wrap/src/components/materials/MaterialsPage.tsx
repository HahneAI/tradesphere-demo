        ...
        <div className="flex items-center gap-2 md:gap-4 min-w-0">
          ...
          <div className="flex flex-col gap-0.5 min-w-0 flex-1">
            <h1 className="text-lg md:text-2xl font-bold truncate" style={{ color: visualConfig.colors.text.primary }}>
              ...
              <span className="hidden md:inline">Materials Management</span>
            </h1>
            <div className="flex items-center gap-2 text-xs md:text-sm" style={{ color: visualConfig.colors.text.secondary }}>
              <Icons.Package className="h-3.5 w-3.5 md:h-4 md:w-4" />
              <span className="hidden md:inline">{filteredCategories.length} categories •</span>
              <span className="truncate">{formatServiceName(selectedService)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-3 overflow-x-auto pb-1 -mb-1 scrollbar-hide">
          ...
          <div className="relative flex-shrink-0">
            <select
              ...
              className="pl-3 pr-9 h-10 md:h-11 min-h-[40px] md:min-h-[44px] border rounded-lg text-xs md:text-sm appearance-none cursor-pointer transition-all focus:outline-none focus:ring-2"
              style={{
            ...
            <Icons.ChevronDown
              className="absolute right-2 md:right-3 top-1/2 transform -translate-y-1/2 h-3.5 w-3.5 md:h-4 md:w-4 pointer-events-none"
              style={{ color: visualConfig.colors.text.secondary }}
            />
          </div>

          {/* Filter Input */}
          <div className="relative flex-shrink-0 w-48 md:w-auto">
