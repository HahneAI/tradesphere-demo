...
export const handler = async (event, context) => {
  ...
  try {
    ...
    try {
      ...
      // 3. 🧠 PHASE 2B: Summary generation moved to customer-context function
      // Summaries are now generated when loading conversation history to avoid network timeouts
      console.log('📋 [SUMMARY_INFO] Interaction summaries are now generated by customer-context function');
      console.log('📋 [SUMMARY_INFO] This prevents network timeouts and ensures all past interactions get summarized');
...
// GPT summarization functions removed - now handled by customer-context function
// This prevents network timeouts and ensures all past interactions get summarized
